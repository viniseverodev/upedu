    ...
    <div className="mx-auto max-w-6xl space-y-5">
      <div className="page-header">
        <div>
          ...
          <p className="mt-0.5 text-sm text-gray-400 dark:text-slate-500">Gestão de contratos de matrícula</p>
        </div>
      </div>
      <div className="empty-state">
        ...
        <p className="mt-1 text-xs text-gray-400 dark:text-slate-600">Story 020 — em breve disponível.</p>
      </div>
    </div>
  );
}
